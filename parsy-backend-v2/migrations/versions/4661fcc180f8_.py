...
Revision ID: 4661fcc180f8
Revises: 6a877258d70e
Create Date: 2019-11-03 18:39:22.250958
...
revision = '4661fcc180f8'
down_revision = '6a877258d70e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('semester_start_end_times',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('school_id', sa.Integer(), nullable=False),
    sa.Column('semester', sa.String(length=15), nullable=False),
    ...
    op.add_column('calendar', sa.Column('school_id', sa.Integer(), nullable=False))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('calendar', 'school_id')
    ...
    op.drop_table('slot')
    op.drop_table('semester_start_end_times')
